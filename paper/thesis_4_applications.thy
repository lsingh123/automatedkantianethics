...
text \<open>In this chapter, I present two moral dilemmas and use my system to produce sophisticated, nuanced
responses to these moral dilemmas. These dilemmas serve as examples of how my system could be applied
in practice and demonstrate my system's ability to formalize loger, more complicted ethical arguments. 
Many of the tests in Section \ref{tests} perform metaethical reasoning, which analyzes properties
of morality itself and involves questions about the nature of ethical truth. In this chapter, Iperform
...
navigate the real world, perhaps as a component of a smart doorbell or a chatbot.
...
In Chapter 3, I performed metaethical reasoning using my system (which formalizes an 
...
is a hurdle for an automated Kantian ethical agent. 

In this chapter, I attempt to tackle this challenge and
endow my system with this kind of common sense in the specific case of lying. In order for my 
system to be used to perform applied ethical reasoning, it will need a database
...
in this common sense database. In this chapter, I describe such common sense for the specific example
of lying.
...
In order for someone to trust my system's judgements, they must trust that the
...
systems, as I argued in Section \ref{kantianethics}. As the examples in this section demonstrate, 
Kantian ethics requires a definition of lying (which any other 
...
ethics is formulating a maxim that accurately captures an agent's principle of action, so a fully
automated agent using my system will need some way to formulate these maxims well. In this section,
I manually implement Korsgaard's formulation of certain maxims. In Section Limitations, I address the 
challenge of formulating a maxim and offer some potential solutions.

This chapter will provide examples of the kinds of common sense facts and maxim formulation required to get my system
