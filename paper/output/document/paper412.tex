...
assumption \isa{paper{\isadigit{4}}{\isadigit{1}}{\isadigit{2}}{\isachardot}everyone{\isacharunderscore}can{\isacharprime}t{\isacharunderscore}lie\ {\isasymequiv}\ {\isasymforall}w{\isachardot}\ {\isasymnot}\ {\isacharparenleft}{\isasymforall}s{\isachardot}\ paper{\isadigit{4}}{\isadigit{1}}{\isadigit{2}}{\isachardot}falsely{\isacharunderscore}promise\ s\ w{\isacharparenright}}, which states that, at all worlds, not everyone can falsely promise since 
