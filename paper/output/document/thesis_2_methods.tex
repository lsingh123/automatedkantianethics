...
%
\isamarkupcmt{The necessity operator is an abbreviation, or syntactic sugar for, the higher order
...
\ simp\isanewline
%
\isamarkupcmt{The blue texte below is an example of typical Nitpick output. In this case, Nitpick successfully found a model 
