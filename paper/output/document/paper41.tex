...
\isatagdocument
%
\isamarkupsubsection{Constructing the Formalization%
}
\isamarkuptrue%
%
\endisatagdocument
...
\ M{\isacharcolon}{\isacharcolon}os\isanewline
%
\isamarkupcmt{The constant $M$ will represent the act ``murder."%
}\isanewline
%
\isamarkupcmt{Should I represent this as a set of maxims? should I specify the circumstances and goals?%
}\isanewline
%
\isadelimproof
%
