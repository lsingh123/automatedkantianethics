...
\isatagdocument
%
\isamarkupsubsubsection{Miscellaneous Test%
}
\isamarkuptrue%
%
\endisatagdocument
...
\isamarkupcmt{Isabelle is neither able to find a proof nor a countermodel for the statement above, so I can't say 
  ...
  my project, so I will defer such a proof until later.%
}%
\endisatagproof
{\isafoldproof}%
%
