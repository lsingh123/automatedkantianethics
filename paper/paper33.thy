...
the goals, and in the next chapter I will present my custom formalization. \<close>
...
text \<open>\textbf{Practical Contradiction Interpretation} Second, Kantians debate the correct interpretation of the formula of universal law because Kant appears to 
